...
public class Main {
  static LinkedList<String> OTPbank;
  static int currIteration;
  static String initVector;
  static String currOTP = "";
  static String prevOTP = getIV();
  static byte[] sha2 = new byte[0];
  static StringBuilder hexString = null;
  ...
  public static void run(String[] args) {
    ...
    // if (isFound == true) {
    // System.out.println("OTP found at pos(" + syncNumber + ")! Authentication
    // accepted.");
    // if (DEBUG) {
    // System.out.println("Synchronization off expected by: (" + syncNumber + ")
    // positions. Adjusting...");
    // }
    // OTPsync(OTPbank, syncNumber); // Must be called even with 0, since the bank
    // should be advanced by 1
    // } else {
    // System.out.println("Authentication error. OTP could not be validated. Buffer
    // holding position.");
    // }
    // System.out.println();
  ...
  private static void createAndShowGUI() {
    ...
    btnTest.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent evt) {
        Thread thread = new Thread(new Runnable() {
          public void run() {
            int numtests = 500000; // CHANGE THIS
    ...
    btnTestBattery.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        if (DEBUG) {
          printOTPBuffer(OTPbank);
        }
